...
//				Toast.makeText(NoteList.this, "Clicked pink Floating Action Button", Toast.LENGTH_SHORT).show();
//			}
//		});



		FloatingActionButton button = (FloatingActionButton) findViewById(R.id.addnotebutton);
		button.setSize(FloatingActionButton.SIZE_MINI);
		button.setColorNormalResId(R.color.pink);
		button.setColorPressedResId(R.color.pink_pressed);
		button.setIcon(R.drawable.create_note);
		button.setStrokeVisible(false);
		button.setTitle("Add new note.");
